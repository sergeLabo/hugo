...
class Training:
    ...
    def get_aitextgen(  vocab_file=vocab_file,
        ...
        return aitextgen( vocab_file=vocab_file,
                        merges_file=merges_file,
                        config=self.config)
    ...
    def training(file_name):
        ...
        **kwargs,
        ...
        train_tokenizer(file_name, vocab_size=self.vocab_size)
        self.vocab_file = "aitextgen-vocab.json"
        self.merges_file = "aitextgen-merges.txt"

        ai = get_aitextgen( vocab_file=self.vocab_file,
                            merges_file=self.merges_file,
                            config=self.config)
