...
def download_file_with_progress(url_base: str, sub_dir: str, model_name: str,
                                file_name: str):
    """
...
def build_gpt2_config(  vocab_size: int = 10000,
                        bos_token_id: int = 0,
                        eos_token_id: int = 0,
                        max_length: int = 1024,
                        dropout: float = 0.0,
...
def GPT2ConfigCPU(  vocab_size: int = 5000,
                    bos_token_id: int = 0,
                    eos_token_id: int = 0,
                    **kwargs):
    """
